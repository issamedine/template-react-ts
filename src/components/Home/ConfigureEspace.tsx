...
const ConfigureEspace = () => {
  return (
    <div className="config-espace container">
      ...
      <div className="content">
        ...
        <div className="text">
          <p className="title">Configurez votre espace</p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laudantium
            itaque iusto veniam nemo
          </p>
        </div>
      </div>
...
export default ConfigureEspace;
