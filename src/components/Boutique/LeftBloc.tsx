...
const LeftBloc: React.FC = () => {
  return (
    <div className="wrapper-left-bloc">
      <ul className="card-left-bloc">
        <li>CATEGORIES</li>
